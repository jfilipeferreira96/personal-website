...
function loadingAnimation() {
  ...
  tl.to("#botao", 0.25, { css: { x: -1, y: 0.9, opacity: 1, scale: 1.3, transformOrigin: "0% 100%, " }, ease: Power1.easeInOut });
  tl.to("#botao", 0.45, {
    css: { x: 0, y: 0, rotation: 0, scale: 1, transformOrigin: "0% 100%" },
    ease: Power1.easeInOut,
    onComplete: function () {
      gsap.fromTo("#wrapper", { opacity: 0 }, { opacity: 1, ease: Power1.easeInOut, duration: 2 });
    },
  });
...
resume.addEventListener("click", (e) => {
  ...
  if (wasResumePressed < 1) {
    tl2.to("#botao", 0.25, { css: { x: -1, y: 0.9, opacity: 1, scale: 1.3, transformOrigin: "0% 100%, " }, ease: Power1.easeInOut });
  ...
  setTimeout(() => {
    resetResumeButton();
    let urlCurriculum = "https://jfilipeferreira96.github.io/personal-website/resume/Curriculum_Vitae_Jose_Filipe_Ferreira_EN.pdf";
...
function resetResumeButton() {
  resume.classList.remove("active"), resume.removeAttribute("disabled"), email.removeAttribute("disabled"), wasResumePressed++;
}
...
function resetEmailButton() {
  (window.location.href = "mailto:filipeferreira96@hotmail.com"), email.classList.remove("active"), resume.removeAttribute("disabled"), email.removeAttribute("disabled");
  if (isSoundOn) {
